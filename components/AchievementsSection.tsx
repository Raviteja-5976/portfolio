...
export const AchievementsSection = () => {
  ...
  return (
    <section id="achievements" className="min-h-screen py-20 relative overflow-hidden">
      <ParallaxBackground sectionId="achievements" />
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                <div className="flex items-start">
                  <motion.div 
                    className={`p-3 rounded-lg bg-gradient-to-r ${achievement.color} mr-4 flex-shrink-0`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certificates.map((cert, index) => (
              <motion.div
                ...
                whileHover={{ scale: 1.02, y: -5, rotateZ: 2 }}
                className="interactive-card glass-effect p-6 rounded-xl border border-white/10 hover:border-cyan-400/30 transition-all duration-300 group"
              >
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="text-center glass-effect p-6 rounded-xl border border-white/10 hover:border-cyan-400/30 transition-all duration-300 cursor-pointer"
            >
              <motion.div
